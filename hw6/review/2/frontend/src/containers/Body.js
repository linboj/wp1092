...
const Body = () => {
  ...
  const handleAdd = async () => {
    ...
    const {
      data: { message, card },
    } = await axios.get('/api/create-card',{params:{ name, subject,
    score  }});
  ...
  const handleQuery = async () => {
    ...
    } = await axios.get('/api/query',{params:{ type:queryType, string:queryString}}) // TODO: axios.xxx call the right api
